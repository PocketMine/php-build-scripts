#!/bin/bash
[ -z "$PHP_VERSION" ] && PHP_VERSION=${PHP_VERSION:-7.0.6}
...
LIBMCRYPT_VERSION=${LIBMCRYPT_VERSION:-2.5.8}
GMP_VERSION=${GMP_VERSION:-6.1.0}
GMP_VERSION_DIR=${GMP_VERSION_DIR:-6.1.0}
CURL_VERSION=${CURL_VERSION:-curl-7_47_1}
READLINE_VERSION=${READLINE_VERSION:-6.3}
NCURSES_VERSION=${NCURSES_VERSION:-6.0}
PHPNCURSES_VERSION=${PHPNCURSES_VERSION:-1.0.2}
PTHREADS_VERSION=${PTHREADS_VERSION:-3.1.6}
XDEBUG_VERSION=${XDEBUG_VERSION:-2.2.6}
PHP_POCKETMINE_VERSION=${PHP_POCKETMINE_VERSION:-0.0.6}
#UOPZ_VERSION=${UOPZ_VERSION:-2.0.4}
WEAKREF_VERSION=${WEAKREF_VERSION:-0.3.2}
PHPYAML_VERSION=${PHPYAML_VERSION:-2.0.0RC7}
YAML_VERSION=${YAML_VERSION:-0.1.6}
YAML_VERSION_ANDROID=${YAML_VERSION_ANDROID:-0.1.4}
#PHPLEVELDB_VERSION=${PHPLEVELDB_VERSION:-0.1.4}
PHPLEVELDB_VERSION=${PHPLEVELDB_VERSION:-2963815338edfebc5ab8c512bcd2b72f0357ac6e}
#LEVELDB_VERSION=${LEVELDB_VERSION:-1.18}
LEVELDB_VERSION=${LEVELDB_VERSION:-b633756b51390a9970efde9068f60188ca06a724} #Check MacOS
LIBXML_VERSION=${LIBXML_VERSION:-2.9.1}
LIBPNG_VERSION=${LIBPNG_VERSION:-1.6.23}
BCOMPILER_VERSION=${BCOMPILER_VERSION:-1.0.2}
...
if [ "$IS_CROSSCOMPILE" == "yes" ]; then
	...
	if [[ "$COMPILE_TARGET" == "win" ]] || [[ "$COMPILE_TARGET" == "win32" ]]; then
		...
		LEVELDB_VERSION=${LEVELDB_VERSION:-1bd4a335d620b395b0a587b15804f9b2ab3c403f}
